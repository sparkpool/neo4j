...
public final class IndexWriterFactories
{
    ...
    public static LuceneIndexWriterFactory standard()
    {
        return new LuceneIndexWriterFactory()
        {
            ...
            {
                return new LuceneIndexWriterForRuntime( directory, standardConfig() );
            }
        };
    }

    // todo: better name?
    public static LuceneIndexWriterFactory overflowAware()
    {
        return new LuceneIndexWriterFactory()
        {
            @Override
            public LuceneIndexWriter create( Directory directory ) throws IOException
            {
                return new LuceneIndexWriterForPopulation( directory, standardConfig() );
            }
        };
    }
